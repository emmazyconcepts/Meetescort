      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200 text-center">
            ...
            <h1 className="text-xl font-bold text-gray-900 mb-2">Verification Required</h1>
            <p className="text-gray-600 mb-4">Please complete identity verification first.</p>
            <button 
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-200 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Thank you for submitting your verification documents. Our team is reviewing your information.
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
            <p className="text-blue-700 text-sm">
              🔄 <strong>Auto-refresh enabled:</strong> This page will automatically update when you're verified
            </p>
          </div>
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-gray-900">
                {userData?.verificationDoc?.uploadedAt 
                  ? new Date(userData.verificationDoc.uploadedAt).toLocaleDateString()
                  : 'N/A'
                }
              </span>
            </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            <p className="text-sm text-gray-600">
              Need help? <Link href="/contact-support" className="text-blue-600 hover:text-blue-700">Contact support</Link>
            </p>
          </div>
        </div>
      </div>
