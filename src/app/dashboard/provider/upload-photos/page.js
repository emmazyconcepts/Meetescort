    ...
    <div className="min-h-screen p-6">
      <div className="max-w-4xl mx-auto">
        <div className="bg-black/20 rounded-2xl p-8 border border-pink-500/20">
          <h1 className="text-3xl font-bold text-white mb-2">📸 Upload Your Photos</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {photos.map((photo, index) => (
                    <div key={index} className="relative group bg-black/30 rounded-lg p-2">
            ...
            >
              {uploading ? (
                <>
                  ...
                  Uploading... ({Object.values(uploadProgress).filter(p => p === 'uploading').length} remaining)
                </>
              ) : (
            ...
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
              <h4 className="text-blue-300 font-semibold mb-2">🆓 Free Image Hosting</h4>
