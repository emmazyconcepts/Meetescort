    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black">
        <div className="text-center">
          ...
          <p className="text-pink-200">You need to be logged in to access your profile.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm mb-6">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">👤 Provider Profile</h1>
            <p className="text-gray-600">Manage your profile information and photos</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2 font-medium">Ethnicity</label>
                    <input
                      type="text"
                      name="ethnicity"
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2 font-medium">Hair Color</label>
                    <input
                      type="text"
                      name="hairColor"
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2 font-medium">Caters To</label>
                    <select
                      name="catersTo"
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-gray-700 mb-2 font-medium">Incall Price ($)</label>
                      <input
                        type="number"
                        name="incallPrice"
                    ...
                    <div>
                      <label className="block text-gray-700 mb-2 font-medium">Outcall Price ($)</label>
                      <input
                        type="number"
                        name="outcallPrice"
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2 font-medium">Languages</label>
                    <select
                      multiple
                    ...
                    <p className="text-gray-500 text-sm mt-1">Hold Ctrl/Cmd to select multiple languages</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {/* Photos Card */}
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                <h2 className="text-xl font-semibold text-gray-900 mb-4">📸 Photos ({photos.length}/5)</h2>
                ...
                <div className={`border-2 border-dashed rounded-xl p-6 text-center mb-4 ${
                  ...
                  <label
                    ...
                    className={`block ${photos.length >= 5 ? 'cursor-not-allowed' : 'cursor-pointer'}`}
                  >
                    <div className="text-4xl mb-3 text-gray-400">🖼️</div>
                    <div className="text-lg font-medium text-gray-700 mb-1">
                      {photos.length >= 5 ? 'Maximum photos reached' : 'Add Photos'}
                    </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                ...
                <div className="space-y-3">
                  {Object.entries(formData.availability).map(([day, data]) => (
                    <div key={day} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 bg-gray-50 rounded-lg gap-2">
                      <div className="flex items-center space-x-3">
                        ...
                        />
                        <span className="text-gray-700 capitalize min-w-[80px] sm:min-w-[100px]">{day}</span>
                      </div>
                      <input
                        type="text"
                        value={data.hours}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 font-medium">{photos.length}</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <div className="lg:col-span-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Basic Info */}
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">ℹ️ Basic Information</h3>
                  <div className="space-y-3">
                    <ProfileField label="Age Range" value={formData.age} />
                    <ProfileField label="Gender" value={formData.gender} />
                    <ProfileField label="Ethnicity" value={formData.ethnicity} />
                    <ProfileField label="Height" value={formData.height ? `${formData.height} cm` : ''} />
                    <ProfileField label="Body Type" value={formData.bodyType} />
                    <ProfileField label="Hair Color" value={formData.hairColor} />
                    <ProfileField label="Caters To" value={formData.catersTo} />
                  </div>
                </div>
  
                {/* Contact & Services */}
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">💼 Services & Contact</h3>
                  <div className="space-y-3">
                    <ProfileField label="Incall Price" value={formData.incallPrice ? `$${formData.incallPrice}` : ''} />
                    <ProfileField label="Outcall Price" value={formData.outcallPrice ? `$${formData.outcallPrice}` : ''} />
                    <ProfileField label="Languages" value={formData.languages?.join(', ')} />
                    <ProfileField label="Website" value={formData.website} isLink />
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                    {Object.entries(formData.availability).map(([day, data]) => (
                      <div key={day} className={`p-3 rounded-lg text-center ${
                        ...
                        <div className="font-semibold text-gray-900 capitalize">{day.substring(0, 3)}</div>
                        <div className="text-sm text-gray-600">
                          {data.available ? data.hours || 'Available' : 'Unavailable'}
                        </div>
                      </div>
                    ))}
                  </div>
  ...
  return (
    <div>
      ...
      <div className="text-white font-medium">
        {isLink ? (
          <a href={value} target="_blank" rel="noopener noreferrer" className="text-pink-300 hover:text-pink-400">
            {value}
          </a>
        ) : (
          value
