    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-pink-500/30 shadow-2xl relative z-10">
        ...
        <div className="text-center">
          <Link href="/" className="inline-block transform hover:scale-105 transition duration-200">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember-me" className="ml-2 block text-sm text-pink-200">
                Remember me
              </label>
            </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white/5 text-pink-300">Or continue with</span>
          </div>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-pink-200">
            ...
            <Link href="/register" className="text-pink-400 hover:text-pink-300 font-medium transition-colors duration-200 group">
              Sign up now
        ...
        <div className="mt-6 p-3 bg-pink-500/10 border border-pink-500/20 rounded-lg">
          <div className="flex items-start">
            <svg className="w-4 h-4 text-pink-400 mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
